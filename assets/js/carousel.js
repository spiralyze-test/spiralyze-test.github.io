+function ($) {
  ...
  Carousel.prototype.to = function (pos) {
    ...
    if (this.sliding)       return this.$element.one('slid.carousel', function () { that.to(pos) }) // yes, "slid"
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    var slideEvent = $.Event('slide.carousel', {
    ...
    var slidEvent = $.Event('slid.carousel', { relatedTarget: relatedTarget, direction: direction })
